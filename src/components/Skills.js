          ...
          <div className="wrapper">
            <div className="left">
              ...
              >
                ...
                <h3>I Develop my teaching Skills Regularly to Keep Me Update</h3>
                <p>
                I acquared my skills through Hard work.
                </p>
                <h2>Best Skils are Programing,Theory and Artificial Intelligence.</h2>
              </div>
              <div
